...
var csv_export_1 = require("../../types/integrations/csv-export");
                    ...
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, prompts_1["default"]([
                                    ...
                                    },
                                    {
                                        ...
                                        validate: function (s) {
                                            return s.substring(0, 1) === '/' && s.substring(s.length - 4) === '.csv'
                                                ? true
                        ...
                        case 1:
                            ...
                            config_1.updateConfig(function (config) {
                                var CSVExportConfig = config.integrations[integrations_1.IntegrationId.CSVExport] || csv_export_1.defaultCSVExportConfig;
                                CSVExportConfig.name = responses_1.name;
                                CSVExportConfig.transactionPath = responses_1.transactionPath;
                                CSVExportConfig.balancePath = responses_1.balancePath;
                                config.balances.integration = integrations_1.IntegrationId.CSVExport;
                                config.transactions.integration = integrations_1.IntegrationId.CSVExport;
                                config.integrations[integrations_1.IntegrationId.CSVExport] = CSVExportConfig;
                                return config;
                            });
                            logging_1.logInfo('Successfully set up CSV Export Integration.');
                            return [2 /*return*/, resolve()];
                        case 2:
                            e_1 = _a.sent();
                            logging_1.logError('Unable to set up CSV Export Integration.', e_1);
